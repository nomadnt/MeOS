...
scan_mac80211() {
	...
	config_set "$device" vifs "${adhoc:+$adhoc }${mesh:+$mesh }${sta:+$sta }${monitor:+$monitor }${ap:+$ap}"
}
...
config 'wifi-iface' '_msh$devidx'
	option disabled '0'
	option device 'radio$devidx'
	option network 'msh$devidx'
	option ifname 'msh$devidx'
	option mode 'adhoc'
	option ssid 'meos'
...
config 'wifi-iface' '_map$devidx'
	option disabled	'1'
	option device 'radio$devidx'
	option network 'mesh'
	option ifname 'map$devidx'
	option mode	'ap'
	option ssid	'MeOS - Secure'
	option encryption 'psk'
	option key '0p3nm305'
	option isolate '0'
	option maxassoc	'32'

config 'wifi-iface' '_lap$devidx'
	option disabled	'1'
	option device 'radio$devidx'
	option network 'lan'
	option ifname 'lap$devidx'
	option mode	'ap'
	option ssid 'MeOS - Open'
	option encryption 'none'
	option isolate '1'
	option maxassoc '32'
